...
public class Client extends Thread {
     ...
     */
     public void receiveTransactions(Transactions transact)
     {
         ...
         while (i < getNumberOfTransactions())
         {
             ...
             // User Code starts
             // Yield if output buffer isn't full
    ...
    {   
    	...
    	long sendClientRT = System.currentTimeMillis();
        long receiveClientRT = System.currentTimeMillis();
	    /* Implement the code for the run method */

        if(getClientOperation().equals("sending")){
            sendTransactions();
            System.out.println("\n Terminating client sending thread - " + " Running time " + (System.currentTimeMillis() - sendClientRT) + " milliseconds");
        }

        if(getClientOperation().equals("receiving")){
            receiveTransactions(transact);
            System.out.println("\n Terminating client receiving thread - " + " Running time " + (System.currentTimeMillis() - receiveClientRT) + " milliseconds");
        }
